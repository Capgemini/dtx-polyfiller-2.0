...
<ul>
  ...
  <li><strong>Website</strong> refers to , accessible from </li>        <li><strong>Service</strong> refers to the Website.</li>
...
<ul>
	<li>DTX employee number</li>
	<li>DTX settings for auto-filling fields and configuring other features of the extension</li>
</ul>


<h3>Cookies and Chrome Storage</h3>
<p>We use Cookies and similar tracking technologies to store certain information.</p>
